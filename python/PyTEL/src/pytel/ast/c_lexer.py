...
class CLexer(object):
    """ A lexer for the TEL language. After building it, set the
    ...
    ##
    keywords = (
        'AND', 'BREAK', 'CASE', 'CONST', 'CONTINUE', 
        'DEFAULT', 'DO', 'ELSE',  
        'ENDFOR', 'ENDFUNCTION', 'ENDIF', 'ENDWHILE', 'ENDSWITCH', 
        'FLOAT', 'FOR', 'FUNCTION', 'GOTO', 'IF', 'INTEGER', 'NOT', 
        'OR', 'RETURN', 'STRING',
        'SWITCH',  'VOID',  #'UNTIL',
        'WHILE', 
    )
