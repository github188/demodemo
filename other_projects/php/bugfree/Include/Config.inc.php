...
$_CFG['DB']['User']        = SAE_MYSQL_USER; #'root';
$_CFG['DB']['Password']    = SAE_MYSQL_PASS; #'';
$_CFG['DB']['Host']        = SAE_MYSQL_HOST_M . ':'. SAE_MYSQL_PORT; #'localhost';
$_CFG['DB']['Database']    = SAE_MYSQL_DB; #'bugfree2';
...
$_CFG['TPLCompileDir']  = SAE_TMP_PATH; #$_CFG['RealRootPath'] . '/Data/TplCompile';
