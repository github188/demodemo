...
document.writeln('	.pwdChkCon0 {float: left;background: #EBEBEB;border-right: 1px solid #BEBEBE;border-bottom: 1px solid #BEBEBE;text-align: center;height: 16px;line-height: 16px;width: 52px;}');
document.writeln('	.pwdChkCon1 {float: left;background: #FF4545;border-right: 1px solid #BB2B2B;border-bottom: 1px solid #BB2B2B;text-align: center;height: 16px;line-height: 16px;width: 52px;}');
document.writeln('	.pwdChkCon2 {float: left;background: #FFD35E;border-right: 1px solid #E9AE10;border-bottom: 1px solid #E9AE10;text-align: center;height: 16px;line-height: 16px;width: 52px;}');
document.writeln('	.pwdChkCon3 {float: left;background: #3ABB1C;border-right: 1px solid #267A12;border-bottom: 1px solid #267A12;text-align: center;height: 16px;line-height: 16px;width: 52px;}');
document.writeln('	.pwdChkCon4 {float: left;background: #3ABB1C;border-right: 1px solid #267A12;border-bottom: 1px solid #267A12;text-align: center;height: 16px;line-height: 16px;width: 52px;}');
