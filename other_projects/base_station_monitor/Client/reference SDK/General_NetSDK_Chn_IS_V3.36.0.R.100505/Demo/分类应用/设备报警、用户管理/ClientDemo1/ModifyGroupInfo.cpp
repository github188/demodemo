...
BOOL CModifyGroupInfo::OnInitDialog() 
{
	...
	GetDlgItem(IDC_EDIT_GROUPNAME)->SetWindowText(m_usersInfo->groupList[m_dwGroupID].name);
	GetDlgItem(IDC_EDIT_NEWGROUPNAME)->SetWindowText(m_usersInfo->groupList[m_dwGroupID].name);
	
	GetDlgItem(IDC_EDIT_MEMO)->SetWindowText(m_usersInfo->groupList[m_dwGroupID].memo);
	GetDlgItem(IDC_EDIT_NEWMEMO)->SetWindowText(m_usersInfo->groupList[m_dwGroupID].memo);
