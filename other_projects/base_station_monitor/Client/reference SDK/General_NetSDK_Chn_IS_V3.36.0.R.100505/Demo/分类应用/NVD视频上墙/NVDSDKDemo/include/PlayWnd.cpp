...
void CPlayWnd::OnContextMenu(CWnd* pWnd, CPoint point) 
{
	...
	menu.AppendMenu(MF_STRING | GET_PARENT_MONITOR->GetFullScreen() ? MF_CHECKED : MF_UNCHECKED, VIDEO_MENU_FULLSCREEN, NAME_MENU_FULLSCREEN);
	menu.AppendMenu(MF_STRING | GET_PARENT_MONITOR->GetMultiScreen() ? MF_CHECKED : MF_UNCHECKED, VIDEO_MENU_MULTISCREEN, NAME_MENU_MULTISCREEN);
	menu.AppendMenu(MF_STRING | GET_PARENT_MONITOR->GetAutoAdjustPos() ? MF_CHECKED : MF_UNCHECKED, VIDEO_MENU_AUTOADJUST, NAME_MENU_AUTOADJUST);
