...
{
	if(1 == nError)		MessageBox("密码不正确!","提示");
	else if(2 == nError)	MessageBox("帐号不存在!","提示");
	else if(3 == nError)	MessageBox("等待登录返回超时!","提示");
	else if(4 == nError)	MessageBox("帐号已登录!","提示");
	else if(5 == nError)	MessageBox("帐号已被锁定!","提示");
	else if(6 == nError)	MessageBox("帐号又被列为黑名单!","提示");
	else if(7 == nError)	MessageBox("资源不足，系统忙!","提示");
	else if(9 == nError)	MessageBox("找不到网络主机!","提示");
	else	MessageBox("登入失败!","提示");
}
