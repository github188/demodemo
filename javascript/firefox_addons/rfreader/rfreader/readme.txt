...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\rfreader on
     Windows, /home/user/dev/rfreader on Linux) in a file named
     robotframeworkreader@deonwu and copy that file to
